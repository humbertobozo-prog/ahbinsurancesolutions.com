...
export const translations: Record<Language, TranslationContent> = {
  en: {
    ...
    cta: {
      medicare: "Request a Medicare Plan Comparison",
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Indexed Universal Life insurance offers more than a death benefit. It's a powerful tool to grow tax-advantaged cash value for a worry-free retirement.",
    ...
    trustBadges: {
        ...
        items: [
            ...
            },
            {
                ...
                description: "Verified NPN 21228432. Certified to provide personalized and independent quotes."
            }
        ]
    },
    contactForm: {
  ...
  es: {
    ...
    cta: {
      medicare: "Solicitar una comparación de planes de Medicare",
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "El seguro de Vida Universal Indexada es una herramienta poderosa para acumular valor en efectivo con ventajas fiscales para su retiro.",
