                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="space-y-2 text-xs font-bold uppercase tracking-wider">
                            ...
                            <li><a href="/locations/gainesville-fl" onClick={(e) => { e.preventDefault(); window.history.pushState({}, '', '/locations/gainesville-fl'); window.dispatchEvent(new Event('popstate')); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="text-amber-400 hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none px-1 rounded transition-colors font-black">📍 Gainesville FL Office</a></li>
                            ...
                            <li><a href="/about-andres-bozo" onClick={(e) => { e.preventDefault(); window.history.pushState({}, '', '/about-andres-bozo'); window.dispatchEvent(new Event('popstate')); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="text-gray-200 hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none px-1 rounded transition-colors">{content.links.about}</a></li>
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <ul className="space-y-2 text-xs font-bold uppercase tracking-wider">
                            ...
                            <li><a href="/es/locations/gainesville-fl" onClick={(e) => { e.preventDefault(); window.history.pushState({}, '', '/es/locations/gainesville-fl'); window.dispatchEvent(new Event('popstate')); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="text-amber-400 hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none px-1 rounded transition-colors font-black">📍 Oficina en Gainesville FL</a></li>
                            ...
                            <li><a href="/es/sobre-andres-bozo" onClick={(e) => { e.preventDefault(); window.history.pushState({}, '', '/es/sobre-andres-bozo'); window.dispatchEvent(new Event('popstate')); window.scrollTo({top: 0, behavior: 'smooth'}); }} className="text-gray-200 hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none px-1 rounded transition-colors">Sobre Andrés Bozo</a></li>
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <ul className="space-y-3 text-gray-200">
                            <li>
                                <a href={GOOGLE_MAPS_URL} target="_blank" rel="noopener noreferrer" className="flex items-start hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none p-1 rounded transition-colors">
                                    ...
                                    <span className="whitespace-pre-line leading-relaxed">
                                        5500 SW Archer Road, Apt H103{"\n"}
                                        Gainesville, FL 32607, USA
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href={`tel:${content.phone.replace(/-/g, '')}`} className="hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none p-1 rounded transition-colors flex items-center">
                            ...
                            <li>
                                <a href={`mailto:${content.email}`} className="hover:text-accent focus-visible:ring-2 focus-visible:ring-accent outline-none p-1 rounded transition-colors flex items-center">
                                    <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 flex-shrink-0 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
